...
describe('field workflow requirements',()=>{
 ...
 it('rejects invalid serials, placeholder jobs and reversed dates',()=>expect(setupMissing({...base,jobNo:'J#',endAt:'2026-09-22',sharedSite:{...base.sharedSite,serialNumberText:'unknown'}},user).map(i=>i.label)).toEqual(expect.arrayContaining(['Job number','Valid end date'])));
